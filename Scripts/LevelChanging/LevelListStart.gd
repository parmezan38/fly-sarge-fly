...
func _input(event):
	if event.is_action_pressed("exit") or event.is_action_pressed("move_left") or event.is_action_pressed("jump") or event.is_action_pressed("move_right"):
		if able_to_start:
			start_game()

func _process(delta):
	var saveFile2Check = File.new()
	var configFile2Check = File.new()
	var doesSaveFileExists = saveFile2Check.file_exists("res://savegame.save")
	var doesConfigFileExists = configFile2Check.file_exists("res://config.save")
	...
	if !doesConfigFileExists:
		...
		do_config_everything_first_time()
		return
	
	if doesSaveFileExists and doesConfigFileExists:
		able_to_start = true
		#start_game()
		pass
	else:
...
func do_config_everything_first_time():
	config_first_time()
...
func level_list_first_time():
	levelList = {
		...
		room_007 = {"accessible":false, "number":007, "name":"room_007", "location":"res://Scenes/Room_003.tscn"},
		room_011 = {"accessible":false, "number":011, "name":"room_011", "location":"res://Scenes/Room_003.tscn"},
		room_015 = {"accessible":false, "number":015, "name":"room_015", "location":"res://Scenes/Room_003.tscn"},
		room_019 = {"accessible":false, "number":019, "name":"room_019", "location":"res://Scenes/Room_003.tscn"},
		room_023 = {"accessible":false, "number":023, "name":"room_023", "location":"res://Scenes/Room_003.tscn"},
		room_027 = {"accessible":false, "number":027, "name":"room_027", "location":"res://Scenes/Room_003.tscn"},
		room_031 = {"accessible":false, "number":031, "name":"room_031", "location":"res://Scenes/Room_003.tscn"},
		room_032 = {"accessible":false, "number":032, "name":"room_032", "location":"res://Scenes/Room_003.tscn"},
		room_034 = {"accessible":false, "number":034, "name":"room_034", "location":"res://Scenes/Room_003.tscn"},
		room_038 = {"accessible":false, "number":038, "name":"room_038", "location":"res://Scenes/Room_003.tscn"},
		end = {"accessible":false, "number":999, "name":"end", "location":"res://Scenes/End.tscn"},
	}
	pass
